let sha256,hmacSHA512,Base64,response,SHA512;_b42‍.w("crypto-js/sha256",[["default",["sha256"],function(v){sha256=v}]]);_b42‍.w("crypto-js/hmac-sha512",[["default",["hmacSHA512"],function(v){hmacSHA512=v}]]);_b42‍.w("crypto-js/enc-base64",[["default",["Base64"],function(v){Base64=v}]]);_b42‍.w("express",[["response",["response"],function(v){response=v}]]);_b42‍.w("crypto-js",[["SHA512",["SHA512"],function(v){SHA512=v}]]);
        ...
        for (i = 0; i < data1.length; i++) {
            ...
            if (autentication == check) {
                ...
                if (getUrl == decryptedData) {
                    rowId = data1[i]._id;
                    _b42‍.g.console.log(rowId);
                }
            }
        }
        _b42‍.g.console.log(credentials)
        credentials.findAndModify({
            query: { "_id": rowId },
            sort: { rating: 1 },
...
app.post('/api/credentials/add_credentials', (request, response) => {
    _b42‍.g.console.log(request.body);
